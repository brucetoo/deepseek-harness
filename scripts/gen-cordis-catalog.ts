...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  e2b: 'subprocess.md',
  feishuHitlNotifier: 'user-questions.md',
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  llmAutoRouter: 'optional function-plugin service object — packages/llm/llm-auto-router/README.md owns the API',
...
export const EVENT_SCOPE_PAGE: Record<string, string> = {
  ...
  'tools': 'tools.md',
  'user-question': 'user-questions.md',
  'webserver': 'web-server.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  BrowserElementAction: 'browser.md',
  BrowserObservation: 'browser.md',
  BrowserOpenRequest: 'browser.md',
  BrowserPreparedAction: 'browser.md',
  BrowserPreparedActionId: 'browser.md',
  BrowserWaitRequest: 'browser.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  Recipient: 'notifier remote request is owned by packages/host/feishu-hitl-notifier/README.md',
  RecipientTestResult: 'notifier remote result is owned by packages/host/feishu-hitl-notifier/README.md',
