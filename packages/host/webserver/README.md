...
- **No TLS or origin policy** — bearer authentication is optional and supplies no encryption; binding a non-loopback address still exposes traffic to that network, so deployments require TLS termination and their own origin policy.
