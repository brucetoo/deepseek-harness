...
import type {
  ClientResponse, HostFrame, IApiClient, ModelSelectionIntent, MuxFrame, ResolvedModelRoute,
  RpcError, RpcReceipt, RpcRequest, RpcResponse, SessionId, SessionModels, SessionSearchItem,
  SkillEntry, WorkspaceId, WorkspaceView,
...
export class FakeApiClient implements IApiClient {
  ...
  readonly defaultModel: ModelSelectionIntent = {
  ...
  onSelectModel: (payload: { sessionId: SessionId; selection: ModelSelectionIntent }) =>
  Promise<RpcResponse<{
    selected: ModelSelectionIntent
    lastRoute?: ResolvedModelRoute
    routable: boolean
  }>> = payload => Promise.resolve(ok({ selected: payload.selection, routable: true }))
  ...
  readonly sessions: IApiClient['sessions'] = {
    ...
    selectModel: (payload: { sessionId: SessionId; selection: ModelSelectionIntent }) =>
