...
/** Service required for the model guidance paired with the browser renderer. */
...
const FILE_REFERENCE_PROMPT = 'When you successfully create or modify files, mention the primary outputs in your final response. '
  + 'To make changed-file references clickable in Web, format them as Markdown inline code using the exact registered or file-tool path, or a basename when unique among the files changed in that turn.'
