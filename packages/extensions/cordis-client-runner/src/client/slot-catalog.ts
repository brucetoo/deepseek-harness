...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-deliverables DeliverablesView id \'deliverables\'',
  ...
  },
  {
    ...
    keyDomain: 'open: any string the owner dispatches (no compile-time key set), already taken: feishu-hitl-notifier',
    hookContext: '',
    slotInject: '',
    ...
    occupants: [
      ...
      'feishu-hitl-notifier FeishuSettingsCard key \'feishu-hitl-notifier\'',
    ],
    replaceRisk: 'shadows-shipped-ui',
