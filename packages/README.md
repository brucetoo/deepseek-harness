...
| [`browser/`](browser/README.md) | Visible public-browser capability: owner-scoped seam, Electron/Playwright provider, and approval-aware tools | Product — preview API |
