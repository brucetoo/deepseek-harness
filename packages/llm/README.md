...
| [`llm-auto-router/`](llm-auto-router/README.md) | Availability-first automatic route policy | `ctx.llmAutoRouter` and Agent request listeners |
| [`llm-deepseek/`](llm-deepseek/README.md) | Direct DeepSeek adapter | registers on `ctx.llm` |
| [`llm-modelhub/`](llm-modelhub/README.md) | Optional ByteDance ModelHub adapter and bundle | registers on `ctx.llm` |
