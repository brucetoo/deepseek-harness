...
Source: [`packages/core/agent-default-model/src/index.ts:58`](../packages/core/agent-default-model/src/index.ts)
...
Requires: `userQuestions` · `sessionTitle` · `subprocess`
...
Source: [`packages/host/feishu-hitl-notifier/src/index.ts:34`](../packages/host/feishu-hitl-notifier/src/index.ts)
...
Requires: `agents` · `llm` · `sessions` · `tokenMeter`
...
Source: [`packages/llm/llm-auto-router/src/index.ts:71`](../packages/llm/llm-auto-router/src/index.ts)
